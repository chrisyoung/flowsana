...
* Add a dsl for listener callbacks, ie: listens_for: :message, might make assignments automatically.
* Add new adapter style to generators (see Adapters::AR::Position)

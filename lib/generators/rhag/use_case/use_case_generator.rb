module Rhag
  class UseCaseGenerator < Rails::Generators::NamedBase
    ...
    def copy_use_case_file
      ...
      template "repository_adapter_spec.rb.erb", "spec/models/repository/adapters/#{repository_name}.rb"
      template "repository_memory_spec.rb.erb", "spec/models/repository/memory/#{repository_name}.rb"
      template "repository_database_spec.rb.erb", "spec/models/repository/database/#{repository_name}.rb"
      template "use_case_spec.rb.erb", "spec/models/use_case/#{file_name}.rb"
      template "model_spec.rb.erb", "spec/models/#{repository_name}.rb"
    end
  end
end
